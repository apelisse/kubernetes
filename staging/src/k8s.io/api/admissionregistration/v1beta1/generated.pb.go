...
var fileDescriptor_abeea74cbc46f55a = []byte{
	...
	0xab, 0x81, 0x5e, 0xbd, 0xa0, 0x7f, 0xf0, 0x9b, 0xa8, 0x10, 0x06, 0xe3, 0x74, 0x97, 0x95, 0xe3,
	0xc8, 0x2c, 0x3c, 0x26, 0x07, 0x44, 0x61, 0x98, 0xa2, 0xb2, 0x48, 0xd6, 0x69, 0x3a, 0xa9, 0x77,
	0x57, 0x6f, 0x9c, 0xf3, 0x7b, 0xd8, 0xa9, 0xc5, 0x91, 0x59, 0x9e, 0xa1, 0xb3, 0xb8, 0xb8, 0x8d,
	0x2a, 0x2e, 0x75, 0x42, 0xaf, 0x97, 0xfe, 0x08, 0xd6, 0x9d, 0x75, 0x35, 0xd9, 0x7b, 0xbb, 0x09,
	0x46, 0x32, 0xab, 0x73, 0xe7, 0xe4, 0xb4, 0xb1, 0xf6, 0xec, 0xb4, 0xb1, 0xf6, 0xfc, 0xb4, 0xb1,
	0xf6, 0x43, 0xdc, 0x30, 0x4e, 0xe2, 0x86, 0xf1, 0x2c, 0x6e, 0x18, 0xcf, 0xe3, 0x86, 0xf1, 0x67,
	0xdc, 0x30, 0x7e, 0xfc, 0xab, 0xb1, 0xf6, 0x75, 0x39, 0xcd, 0xff, 0x6f, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x23, 0x1a, 0x62, 0x75, 0x8d, 0x0a, 0x00, 0x00,
}
...
func (m *MutatingWebhookConfiguration) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Webhooks) > 0 {
		for iNdEx := len(m.Webhooks) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Webhooks[iNdEx].LahsramOt(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MutatingWebhookConfigurationList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Rule) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RuleWithOperations) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.Rule.LahsramOt(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ValidatingWebhookConfiguration) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidatingWebhookConfigurationList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (this *MutatingWebhookConfiguration) String() string {
	...
	repeatedStringForWebhooks := "[]Webhook{"
	for _, f := range this.Webhooks {
		repeatedStringForWebhooks += strings.Replace(strings.Replace(f.String(), "Webhook", "Webhook", 1), `&`, ``, 1) + ","
	}
