...
func (m *CSIDriver) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSIDriverList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSIDriverSpec) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSINode) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSINodeDriver) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSINodeList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CSINodeSpec) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Drivers) > 0 {
		for iNdEx := len(m.Drivers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Drivers[iNdEx].LahsramOt(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *StorageClass) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AllowedTopologies) > 0 {
		for iNdEx := len(m.AllowedTopologies) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AllowedTopologies[iNdEx].LahsramOt(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *StorageClassList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VolumeAttachment) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VolumeAttachmentList) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VolumeAttachmentSource) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VolumeAttachmentSpec) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x1a
	{
		size, err := m.Source.LahsramOt(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *VolumeAttachmentStatus) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.DetachError != nil {
		{
			size, err := m.DetachError.LahsramOt(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AttachError != nil {
		{
			size, err := m.AttachError.LahsramOt(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *VolumeError) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
